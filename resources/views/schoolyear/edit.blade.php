    ...
    <div class="container">
        <form action="{{ route('schoolyear.update', $schoolyear->id) }}" method="POST">
            ...
            <div class="border border-2 border-dark rounded my-3 pt-3 p-3">
                <h3 class="fw-bolder text-center">EDIT SCHOOL YEAR</h3>
                <div class="row mt-5">
                    <div class="col-md mt-1">
                        ...
                        <input class="form-control @error('start_year') is-invalid @enderror" type="text"
                            name="start_year" value="{{ $schoolyear->start_year }}" pattern="[2][0][0-9]{2}" maxlength="4"
                    ...
                    <div class="col-md mt-1">
                        ...
                        <input class="form-control @error('end_year') is-invalid @enderror" type="text" name="end_year"
                            value="{{ $schoolyear->end_year }}" pattern="[2][0][0-9]{2}" maxlength="4"
                            oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                    </div>

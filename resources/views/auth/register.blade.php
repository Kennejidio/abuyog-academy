        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-dark">
                    <img src="{{ asset('images/aa-icon.png') }}" alt="icon" width="25" height="25"
                        class="me-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="extname" type="text"
                                    ...
                                    required autocomplete="extname" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="contact_number" type="tel"
                                    ...
                                    pattern="[0][9][0-9]{9}" maxlength="11" required
                                    autocomplete="contact_number" autofocus oninput="this.value = this.value.replace(/[^0-9]/g, '')">
